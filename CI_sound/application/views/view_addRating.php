                            ...
                            <div class="card-body card-block">
                                <form action="<?php echo base_url().'c_add/rate/' ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"><input type="text" name="id" class="form-control" placeholder="Enter Name"><small class="form-text text-muted">Please enter your ID</small></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="email-input" class=" form-control-label">ID Recording</label></div>
                                        <div class="col-12 col-md-9"><input type="text" name="idr" placeholder="Enter ID" class="form-control"><small class="help-block form-text">Please enter ID Recording</small></div>
                                    </div>
                                    <div class="row form-group">
