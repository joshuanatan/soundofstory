                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                <div class="box-header">
                                    <h3 class="box-title">User Recording</h3>
                                </div>
                                <br>
                                <div class="col-xs-2">
                                    <a href="<?php echo base_url().'Welcome/tmbhUserRec' ?>"><button class="btn btn-block btn-primary btn-flat">Add User Recording</button></a>
                                </div>
                                <br><br>
                                <!-- /.box-header -->
                                <div class="box-body">
