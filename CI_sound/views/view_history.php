                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                <div class="box-header">
                                    <h3 class="box-title">History of Recording</h3>
                                </div>
                                <br>
                                <!--<div class="col-xs-2">
                                    <a href="<?php echo base_url().'Welcome/tmbhHistory' ?>"><button class="btn btn-block btn-primary btn-flat">Add Rating</button></a>
                                </div>
                                <br><br>-->
                                <!-- /.box-header -->
                                <div class="box-body">
