...
<header class="main-header">
    <!-- Logo -->
    <a href="<?php echo base_url().'c_login' ?>" class="logo">
        <!-- mini logo for sidebar mini 50x50 pixels -->
        <span class="logo-mini"><b>S</b>S</span>
        <!-- logo for regular state and mobile devices -->
        <span class="logo-lg"><b>Sound</b>OfStory</span>
    </a>
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li>
                            ...
                            <ul class="menu">
                                <li>
                                    <a href="#">
                                        <i class="fa fa-shopping-cart text-green"></i> <?php echo $total ?> sales made
                                    </a>
                                </li>
                                </ul>
                            </li>
