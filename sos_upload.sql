...
--
-- Host: 127.0.0.1
-- Generation Time: May 25, 2019 at 04:59 AM
...
(6, 'Joshua Natan', 'b46b5c24291ba546a734698b685918d4', 1, 'joshuanatan.jn@gmail.com', '089616961915', 'default.jpg', 1, '2019-05-25'),
...
--
ALTER TABLE `playlist`
  MODIFY `id_playlist` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `recording`
  MODIFY `id_recording` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
