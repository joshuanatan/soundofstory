                    ...
                    <div class="card-body card-block">
                        <form action="<?php echo base_url().'c_add/user/' ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9"><input type="password" id="password" name="passwor" placeholder="Password" class="form-control" required><small class="help-block form-text">Please enter a complex password</small></div>
                            </div>
                            <div class="row form-group">
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9"><input type="file" name="pic1" class="form-control" required></div>
                            </div>
