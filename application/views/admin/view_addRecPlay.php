                    ...
                    <div class="card-body card-block">
                        <form action="<?php echo base_url().'c_add/recplay/' ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9"><input type="text" name="idr" class="form-control" placeholder="Enter ID" required><small class="form-text text-muted">Please enter ID Recording</small></div>
                            </div>
                            <div class="row form-group">
                                <div class="col col-md-3"><label for="text-input" class=" form-control-label">ID Playlist</label></div>
                                <div class="col-12 col-md-9"><input type="text" name="idp" class="form-control" placeholder="Enter ID" required><small class="form-text text-muted">Please enter ID Playlist</small></div>
                            </div>
