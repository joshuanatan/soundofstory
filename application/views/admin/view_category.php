                            ...
                            <tbody>
                                <?php
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="<?php echo base_url().'c_edit/cate/'.$list->id_category ?>"><button class="btn btn-primary btn-outline"><i class = "fa fa-edit"></i></button></a><a href="<?php echo base_url().'c_delete/cate/'.$list->id_category ?>"><button class="btn btn-danger btn-outline"><i class = "fa fa-trash"></i></button></a></td>
                                    </tr>
                                    <?php } ?>
                            </tbody>
                        </table>
