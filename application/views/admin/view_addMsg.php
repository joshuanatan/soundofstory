                    ...
                    <div class="card-body card-block">
                        <form action="<?php echo base_url().'c_add/msg/' ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
                            <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9"><input type="text" name="isi" class="form-control" placeholder="Enter Name"><small class="form-text text-muted">Please enter your message</small></div>
                            </div>
                            <div class="row form-group">
                                <div class="col col-md-3"><label for="text-input" class=" form-control-label">From (ID)</label></div>
                                <div class="col-12 col-md-9"><input type="text" name="fid" class="form-control" placeholder="Enter Name"></div>
                            </div>
                            <div class="row form-group">
                                <div class="col col-md-3"><label for="text-input" class=" form-control-label">To (ID)</label></div>
                                <div class="col-12 col-md-9"><input type="text" name="tid" class="form-control" placeholder="Enter Name"></div>
                            </div>
