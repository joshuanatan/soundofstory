                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="page-header float-right">
                                    <a href="<?php echo base_url().'Welcome/tmbhRating' ?>"><button class="btn">Add Rating</button></a>
                                </div>
                                    ...
                                    <tbody>
                                        <?php
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="<?php echo base_url().'c_edit/rate/'.$list->id_rating ?>"><button class="btn">EDIT</button></a> || <a href="<?php echo base_url().'c_delete/rate/'.$list->id_rating ?>"><button class="btn">DELETE</button></a></td>
                                            </tr>
                                            <?php } ?>
                                    </tbody>
                                </table>
