                            ...
                            <div class="card-body card-block">
                                <form action="<?php echo base_url().'c_add/conn/' ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"><input type="text" name="id" class="form-control" placeholder="Enter ID"></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="text-input" class=" form-control-label">ID 2</label></div>
                                        <div class="col-12 col-md-9"><input type="text" name="idd" class="form-control" placeholder="Enter ID"></div>
                                    </div>
