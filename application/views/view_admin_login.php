        ...
        <div class="container">
            <div class="login-content">
                <div class="login-logo">
                    <a href="index.html">
                        <img class="align-content" src="<?php echo base_url(); ?>assets/ElaAdmin/images/logo.png" alt="">
                    </a>
                </div>
                <div class="login-form">
                    <form action="<?php echo base_url().'admin/login/' ?>" method="post">
                        ...
                        <div class="register-link m-t-15 text-center">
                            <p>Don't have account ? <a href="<?php echo base_url().'admin/registerAdmin/' ?>"> Sign Up Here</a></p>
                        </div>
                    </form>
                </div>
            </div>
