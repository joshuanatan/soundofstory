			...
			<div class="container-fluid">
				<div class="header-wrap">
					<div class="header-top d-flex justify-content-between align-items-center">
						<div class="logo">
							<a href="index.html"><img src="<?php echo base_url();?>assets/landing/img/logo.png" alt=""></a>
						</div>
			...
			<div class="container">
				<div class="row fullscreen align-items-center justify-content-center">
					<div class="banner-left col-lg-6">
						<img class="d-flex mx-auto img-fluid" src="<?php echo base_url();?>assets/landing/img/header-img.png" alt="">
					</div>
					<div class="col-lg-6">
		...
		<section class="video-area pt-40 pb-40">
			...
			<div class="container">
				<div class="video-content">
					<a href="http://www.youtube.com/watch?v=0O2aH4XLbto" class="play-btn"><img src="<?php echo base_url();?>assets/landing/img/play-btn.png" alt=""></a>
		...
		<section class="about-area pt-100 pb-100">
			<div class="container">
				<div class="row align-items-center">
					...
					<div class="col-lg-6">
						<img class="img-fluid d-flex mx-auto" src="<?php echo base_url();?>assets/landing/img/about.png" alt="">
					</div>
				</div>
			</div>
		</section>
