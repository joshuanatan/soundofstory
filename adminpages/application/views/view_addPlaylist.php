                            ...
                            <div class="card-body card-block">
                                <form action="<?php echo base_url().'c_add/play/' ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"><input type="text" name="name" class="form-control" placeholder="Enter ID"><small class="form-text text-muted">Please enter your ID</small></div>
                                    </div>
