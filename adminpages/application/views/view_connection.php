                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="page-header float-right">
                                    <a href="<?php echo base_url().'Welcome/tmbhConn' ?>"><button class="btn">Add Connection</button></a>
                                </div>
                                    ...
                                    <tbody>
                                        <?php
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="<?php echo base_url().'c_edit/conn/'.$list->id_connection ?>"><button class="btn">EDIT</button></a> || <a href="<?php echo base_url().'c_delete/conn/'.$list->id_connection ?>"><button class="btn">DELETE</button></a></td>
                                            </tr>
                                            <?php } ?>
                                    </tbody>
                                </table>
